...
EC_ETC_PATH=${EC_SYS_PATH}/bin/ec/components/qtest/example/test/etc/
EC_SYS_ID="componentXTest"
EC_SYS_TYPE="FUNC_TEST"
export EC_QSL_PATH EC_ETC_PATH EC_SYS_ID EC_SYS_TYPE

# ---- yak environment ---- #
YAK_PATH=$EC_SYS_PATH/bin/yak/
YAK_OPTS="-c $EC_SYS_PATH/etc/system.cfg -v less -s $EC_SYS_PATH/data/test/${EC_SYS_ID}/yak/yak.status -l $EC_SYS_PATH/log/test/${EC_SYS_ID}/yak/yak.log"
