...
set YAK_OPTS=-c %EC_ETC_PATH%/system.cfg -s %EC_SYS_PATH%/data/test/hdbWriterTest/yak/yak.status -l %EC_SYS_PATH%/log/test/hdbWriterTest/yak/yak.log
set PATH=%YAK_PATH%;%PATH%

REM ---- ec enviroment ----
set EC_QSL_PATH=%EC_SYS_PATH%/bin/ec/libraries/qsl/
set EC_ETC_PATH=%EC_SYS_PATH%/bin/ec/components/hdbWriter/test/etc/

set EC_SYS_ID="HdbWriterTest"
