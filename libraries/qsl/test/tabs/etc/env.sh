...
YAK_OPTS="-c $EC_ETC_PATH/system.cfg -v less -s $EC_SYS_PATH/data/test/qslTabsTest/yak/yak.status -l $EC_SYS_PATH/log/test/qslTabsTest/yak/yak.log"
export YAK_OPTS
...
EC_ETC_PATH=${EC_SYS_PATH}/bin/ec/libraries/qsl/test/tabs/etc/
export EC_QSL_PATH EC_ETC_PATH

# ---- cmd prompt decoration ---- #
EC_SYS_ID="qslTabsTest"
