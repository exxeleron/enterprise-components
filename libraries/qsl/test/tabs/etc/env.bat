...
set YAK_OPTS=-c %EC_ETC_PATH%/system.cfg -s %EC_SYS_PATH%/data/test/qslTabsTest/yak/yak.status -l %EC_SYS_PATH%/log/test/qslTabsTest/yak/yak.log
set PATH=%YAK_PATH%;%PATH%

REM ---- ec enviroment ----
set EC_QSL_PATH=%EC_SYS_PATH%/bin/ec/libraries/qsl/
set EC_ETC_PATH=%EC_SYS_PATH%/bin/ec/libraries/qsl/test/tabs/etc/

set EC_SYS_ID="qslTabsTest"
